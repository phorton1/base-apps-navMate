...
# The Leaflet map create/modify/delete E80 waypoint entries used to live here;
# they moved to navLeaflet.pm (Leaflet feature code does not belong in the
# navOps clipboard layer).  They still call the E80 spoke primitives in this
# file (_checkE80NameConflict / _e80WPRoutes / _e80DeleteWP) and _newNavUUID --
# which therefore have a navLeaflet caller as well as the clipboard machinery.
